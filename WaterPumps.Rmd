...
```{r}
xgboost.data = WaterPumps[,c('amount_tsh','gps_height','longitude','latitude','basin','region_code','district_code','population','public_meeting','scheme_management','permit','construction_year','extraction_type_class','management_group','payment_type','quality_group','quantity_group','source_class','waterpoint_type_group')]
...
xgboost.valid.x = xgboost.modelmatrix[valid,]
xgboost.train.y = xgboost.data$response[train]
xgboost.valid.y = xgboost.data$response[valid]
