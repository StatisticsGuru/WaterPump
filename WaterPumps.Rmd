...
ggplot(WaterPumps, aes(x=payment))+
  geom_bar(stat='count', aes(fill=status_group))+
  theme(legend.title=element_blank())+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))+
  ggtitle('Water Pump Status by Payment Type')

ggplot(WaterPumps, aes(x=basin))+
  geom_bar(stat='count', aes(fill=status_group))+
  theme(legend.title=element_blank())+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))+
  ggtitle('Water Pump Status by Basin')

ggplot(WaterPumps, aes(x=quantity_group))+
  geom_bar(stat='count', aes(fill=status_group))+
  theme(legend.title=element_blank())+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))+
  ggtitle('Water Pump Status by Quantity Group')

ggplot(WaterPumps, aes(x=waterpoint_type_group))+
  geom_bar(stat='count', aes(fill=status_group))+
  theme(legend.title=element_blank())+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))+
  ggtitle('Water Pump Status by Waterpoint')
