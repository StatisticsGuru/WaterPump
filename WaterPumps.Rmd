...
## About the Dataset
The datasets for this project were downloaded from www.drivendata.org and consisted of a two files of comma separated format.  This first file contains 40 characteristic data of each water pump, indexed by a pump ID, to be used as predictors.  
...
*Data Modification* Initially the datasets were cleaned to make them compatible with processing. Primarily this consisted of addressing missing data and special characters.  Then the predictor data was merged with the response data into a single dataset.
    ...
    - data excluded
    One predictor was excluded because it was constant for all water pumps. Several other predictors were 
    

## Variable Selection
    - Lasso to get a feel for relevant variables
    - spatial plotting (2 kinds) to get a deel for spatial data
